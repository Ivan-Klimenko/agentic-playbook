...
| 8 | Over-engineering planning (formal plan-and-execute everywhere, or building a plan execution engine) | Doubles latency for simple tasks; rigid step ordering limits LLM flexibility | No-plan for short interactions; prompt-driven plan execution for complex ones ([AGENT_PATTERNS §2.11](./AGENT_PATTERNS.md#211-no-plan-architecture-planning-via-system-prompt), [§2.14](./AGENT_PATTERNS.md#214-prompt-driven-plan-execution-no-engine)) |
